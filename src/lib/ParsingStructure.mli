...
(** Boolean expressions *)
(****************************************************************)
type parsed_discrete_boolean_expression = string
...
type linear_term =
	| Constant of  string
	| Variable of  string * variable_name
...
(****************************************************************)
type parsed_instruction = string
...
type parsed_init_state_predicate =
	...
	| Parsed_linear_predicate of string
	| Parsed_discrete_predicate of variable_name * string
...
type parsed_pval = (string *  string) list

type parsed_pdomain = (string * string * string) list
...
(*	(* Safety with timing constraint *)
	...
	(* Cartography *)
	| Parsed_Cover_cartography of parsed_pdomain * string

	(* Cover the whole cartography using learning-based abstractions *)
	| Parsed_Learning_cartography of parsed_state_predicate * parsed_pdomain * string
	
	(* Cover the whole cartography after shuffling point (mostly useful for the distributed IMITATOR) *)
	| Parsed_Shuffle_cartography of parsed_pdomain * string
	
	(* Look for the border using the cartography*)
	| Parsed_Border_cartography of parsed_pdomain * string
	
	(* Randomly pick up values for a given number of iterations *)
	| Parsed_Random_cartography of parsed_pdomain * int * string
	
	(* Randomly pick up values for a given number of iterations, then switch to sequential algorithm once no more point has been found after a given max number of attempts (mostly useful for the distributed IMITATOR) *)
	| Parsed_RandomSeq_cartography of parsed_pdomain * int * string

	(* Parametric reachability preservation *)
	| Parsed_PRPC of parsed_state_predicate * parsed_pdomain * string
